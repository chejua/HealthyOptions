...
class Wendys extends Restaurant {
  Wendys(String name, String phrase, String imageName) : super(name, phrase, imageName);
  ...
  List<Beer> buildBeers() {
    final List<Beer> beers = [
      Beer(
          id: 1,
          title: 'Chili',
          word: 'Its major ingredients are black beans, wild rice, farro, onions, brown rice, carrots, quinoa, corn, green bell peppers, and red bell peppers; and the sauce and seasonings include red wine vinegar, chili peppers, cumin, cilantro, oregano, and sea salt.',
          rating: 3.2,
          alcohol: 4.5,
          size: 'Small, Large',
          note: 'Its major ingredients are black beans, wild rice, farro, onions, brown rice, carrots, quinoa, corn, green bell peppers, and red bell peppers; and the sauce and seasonings include red wine vinegar, chili peppers, cumin, cilantro, oregano, and sea salt.',
          foodMatch: 'Frys, Chicken Salad',
          image: 'wendys_chili',
